...
$sql = "SELECT id FROM transaction_table WHERE status = '2' AND transaction_department = '3' ORDER BY created_on DESC LIMIT 1";
...
$sql = "SELECT id From transaction_table WHERE status = '1' AND transaction_department = '3' ORDER BY created_on DESC LIMIT 5";
$result = $conn->query($sql);
...
$sql = "SELECT * FROM user_table WHERE office = 'Cashier' AND windows = '1' AND status = '1'";
$result = $conn -> query($sql);
...
$sql = "SELECT * FROM user_table WHERE office = 'Cashier' AND windows = '2' AND status = '1'";
$result = $conn -> query($sql);
