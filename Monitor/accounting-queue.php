...
$sql = "SELECT id, windows, status FROM user_table WHERE office = 'Accounting'";
...
while ($row = $result->fetch_assoc()) {
    ...
    $sql_transaction = "SELECT id FROM transaction_table WHERE status = '2' AND transaction_window = $windows AND transaction_department = '4' AND created_on IS NOT NULL ORDER BY created_on DESC LIMIT 1";
